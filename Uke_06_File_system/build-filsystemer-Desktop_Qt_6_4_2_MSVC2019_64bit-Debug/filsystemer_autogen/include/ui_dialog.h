...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/image_resources/images/view.png"), QSize(), QIcon::Normal, QIcon::On);
        btnRead->setIcon(icon);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/image_resources/images/join.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/images/images/doc-file-format.png"), QSize(), QIcon::Normal, QIcon::On);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/image_resources/images/add-new.png"), QSize(), QIcon::Normal, QIcon::On);
        btnAddFormat->setIcon(icon3);
        ...
        btnStyling = new QPushButton(Dialog);
        btnStyling->setObjectName("btnStyling");

        gridLayout->addWidget(btnStyling, 1, 0, 1, 1);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        btnStyling->setText(QCoreApplication::translate("Dialog", "Styling", nullptr));
    } // retranslateUi
